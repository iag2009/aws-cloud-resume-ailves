...
locals {
  ...
  attach_policy = var.attach_access_log_delivery_policy || var.attach_elb_log_delivery_policy || var.attach_lb_log_delivery_policy || var.attach_inventory_destination_policy || var.attach_policy
...
locals {
  ...
  elb_service_accounts = {
    us-east-1      = "121850521501"
    us-east-2      = "121850521501"
    us-west-1      = "121850521501"
    us-west-2      = "121850521501"
    af-south-1     = "121850521501"
    ap-east-1      = "121850521501"
    ap-south-1     = "121850521501"
    ap-northeast-1 = "121850521501"
    ap-northeast-2 = "121850521501"
    ap-northeast-3 = "121850521501"
    ap-southeast-1 = "121850521501"
    ap-southeast-2 = "121850521501"
    ap-southeast-3 = "121850521501"
    ca-central-1   = "121850521501"
    eu-central-1   = "121850521501"
    eu-west-1      = "121850521501"
    eu-west-2      = "121850521501"
    eu-west-3      = "121850521501"
    eu-south-1     = "121850521501"
    eu-north-1     = "121850521501"
    me-south-1     = "121850521501"
    sa-east-1      = "121850521501"
    us-gov-west-1  = "121850521501"
    us-gov-east-1  = "121850521501"
  }
}
